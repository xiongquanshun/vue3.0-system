    ...
    <div class="login-wrap">
        <div class="ms-login">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" status-icon class="ms-content">
                ...
                <div class="login-btn">
                    <el-button type="primary" @click="submitForm('ruleForm')" :disabled="!confirmSuccess||ruleForm.password==''||ruleForm.username==''"  :loading="loading" round @keyup.enter.native="submitForm('ruleForm')">登录</el-button>
                </div>
