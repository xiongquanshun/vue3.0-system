    ...
    <div class="table systemUser">
        ...
        <div class="container">
            <div class="handle-box" >
                ...
                <el-button type="primary" icon="add" @click="add" style="float:right"> 添加管理员</el-button>
            </div>

            <el-table :data="data" border class="" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column type="selection" width="55" align="center"></el-table-column>
                <el-table-column prop="name" label="账号" width="120" class='_cell'>
                </el-table-column>
                <el-table-column prop="ascription" label=" 姓名 " >
                </el-table-column>
                 <el-table-column prop="copies" label=" 用户角色 " >
                </el-table-column>
                <el-table-column prop="income" label="所属机构" >
                </el-table-column>
                 <el-table-column prop="income" label="联系电话" >
                </el-table-column>
                 <el-table-column prop="income" label="邮箱地址" >
                </el-table-column>
                 <el-table-column prop="income" label="修改时间" >
                </el-table-column>
...
<style>
    .systemUser th{background: rgb(237,242,246)}
    .systemUser .cell{text-align: center}
    .systemUser .el-form-item__label{text-align:left}
    .systemUser .el-dialog{
        position:absolute;
        top: 50%;
        left: 50%;
        margin: 0 !important;
    ...
    .systemUser .el-dialog__header{
        padding:15px;
        text-align: center;
        background: #EDF2F6;
    }
    .systemUser .el-dialog__close{
        display: none
    }
    .systemUser .el-dialog__body {
        padding:0
    }

    .systemUser .el-dialog__header{text-align:center}
    .systemUser .dialog-footer{
        text-align:center;
        display: block;
        padding:45px 0 25px;
        margin-top:-10px;
    }
    .systemUser .dialog-footer button{
        border:none;
        font-size:16px;
        border-radius:6px;
        margin:0 12px;
    ...
    .systemUser .dialog-footer button:active{
        border:none;
    }
    .systemUser .dialog-footer button:hover{
        opacity: 0.6;
    }
    .systemUser .el-dialog  .el-form-item{margin-bottom:0px}
    .systemUser .el-dialog  .el-form{padding:20px 45px;margin:0 auto;background: rgb(242,242,242)}
    .systemUser .el-dialog  .el-form:first-child{background: none}
    .systemUser .el-dialog  .el-form:last-child{border-top:1px solid rgb(204,204,204)}
    .systemUser .unit-input1 input{
        padding-right:46px;
    }
    .systemUser .unit-input2 input{
        padding-right:30px;
    }
    .systemUser .el-switch__core {
        height: 28px;
        border-radius:20px
    }
    .systemUser .el-switch.is-checked .el-switch__core::after{
        margin-left:-25px
    }
    .systemUser .el-switch__core:after{
        width:24px;height: 24px;
    }
    .addForm .el-form-item__label::after,.detail .el-form-item__label::after{
        content: '*';
        color:red;
        margin-left:20px
    }
