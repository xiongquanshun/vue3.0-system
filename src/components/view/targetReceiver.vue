    ...
    <div class="table printPromotion">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" icon="add" @click="add" style="float:right"> 添加人员 </el-button>
            </div>
         ...
         <!-- 新增弹出框 -->
        <el-dialog title="添加接警人员" :visible.sync="addVisible" width="530px">
            <el-form ref="addForm" :model="addForm" label-width="70px" >
                <el-form-item label="姓名">
                 ...
                 <el-form-item label="验证码">
                    <div class="el-form-content">
                        <el-input v-model="addForm.name" ></el-input>
                        <el-button type="primary" icon="add" style='margin-left:10px'>获取短信</el-button>
                    </div>
                </el-form-item>
                ...
                <el-form-item label="允许终端查看收入" label-width="130px">
                    <div class="el-form-content">
                        <el-switch 
                            v-model="switchFlag" 
                            width='60' 
