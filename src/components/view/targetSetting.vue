                ...
                <el-form ref="form" :model="form" >
                    ...
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">预警值</font>
                            <font></font>
                        </div>
                   ...
                   <!-- 耗材补充更换 -->
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">指定运维人员</font>
                            <font></font>
                        </div>
                        <div class='form-title-bar'>
                            <div  class='form-title-bar2'></div>
                    ...
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">预警通知方式</font>
                            <font></font>
                        </div>
                        <div class='form-title-bar'>
                            <div  class='form-title-bar2'></div>
...
<style>
    .targetSetting th{background: rgb(237,242,246)}
    .targetSetting .cell{text-align: center}
    .targetSetting  .addr-select .el-form-item__content{display:flex;}
    .targetSetting .el-form-item__label{width:105px;text-align: left;}

    /* switch */
    .targetSetting .el-switch__core {
        height: 28px;
        border-radius:20px;
    }
    .targetSetting .el-switch.is-checked .el-switch__core::after{
        margin-left:-25px
    }
   .targetSetting .el-switch__core:after{
        width:24px;height: 24px;
    }

    .targetSetting .switch-text .el-switch__label {
        position: absolute;
        display: none;
        color: #fff;
    }
    /*打开时文字位置设置*/
    .targetSetting .switch-text .el-switch__label--right {
    z-index: 1;
    left: -3px;
    }
    /*关闭时文字位置设置*/
    .targetSetting .switch-text .el-switch__label--left {
    z-index: 1;
    right: -6px;
    }
    /*显示文字*/
    .targetSetting .switch-text .el-switch__label.is-active {
    display: block;
    }
...
<style scoped>
    .targetSetting{display: flex;justify-content:center;}
