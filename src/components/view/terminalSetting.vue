<template>
    <div class="table terminalSetting">
                ...
                <el-form ref="form" :model="form" >
                    ...
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">打印机配置</font>
                            <font>管理硬件模板</font>
                        </div>
                    ...
                    <el-form-item label="文档打印机型号"> 
                        <el-select v-model="select_status" placeholder="运行状态" class="handle-select mr10" >
                            <el-option v-for="(item,index) in statusList" :key='index' :label="item.text" :value="item.text" ></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="纸盒满载储纸量">
                        <div>750张</div>
                    </el-form-item>
                    <el-form-item label="硒鼓最大打印量">
                        <div>3000页</div>
                    </el-form-item>

                    <el-form-item label="照片打印机型号">
                        <el-select v-model="select_status" placeholder="运行状态" class="handle-select mr10" >
                            <el-option v-for="(item,index) in statusList" :key='index' :label="item.text" :value="item.text" ></el-option>
                        </el-select>
                    </el-form-item>
                   ...
                   <!-- 收费策略设置 -->
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">
                                收费策略设置(<span style="color:#EB6015;">必填</span>)
                                <span style="font-size:14px;margin-left:10px;font-weight:400">本终端打印的收费标准</span>
                            </font>
                            <font>管理价格模板</font>
                        </div>
                        <div class='form-title-bar'>
                    ...
                    <el-form-item label="文档打印收费策略">
                        <el-select v-model="select_status" placeholder="运行状态" class="handle-select mr10" >
                            <el-option v-for="(item,index) in statusList" :key='index' :label="item.text" :value="item.text" ></el-option>
                        </el-select>
                    </el-form-item>

                    <el-form-item label="照片打印收费策略">
                        <el-select v-model="select_status" placeholder="运行状态" class="handle-select mr10" >
                            <el-option v-for="(item,index) in statusList" :key='index' :label="item.text" :value="item.text" ></el-option>
                        </el-select>
                    </el-form-item>
                    ...
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">
                                阶梯价格策略
                                <span style="font-size:14px;margin-left:10px;font-weight:400">可设置本终端按打印量折扣优惠策略</span>
                            </font>
                            <font>管理阶梯价格</font>
                        </div>
                        <div class='form-title-bar'>
                    ...
                    <el-form-item label="文档阶梯价格策略">
                        <el-select v-model="select_status" placeholder="运行状态" class="handle-select mr10" >
                            <el-option v-for="(item,index) in statusList" :key='index' :label="item.text" :value="item.text" ></el-option>
                        </el-select>
                    </el-form-item>

                    <el-form-item label="照片阶梯价格策略">
                        <el-select v-model="select_status" placeholder="运行状态" class="handle-select mr10" >
                            <el-option v-for="(item,index) in statusList" :key='index' :label="item.text" :value="item.text" ></el-option>
                        </el-select>
                    </el-form-item>
                    ...
                    <div class='form-title'>
                        <div class='form-title-text'>
                            <font style="font-size:16px;font-weight:600">
                                促销免费策略
                                <span style="font-size:14px;margin-left:10px;font-weight:400">可设置本终端启用那种促销免费策略</span>
                            </font>
                            <font>管理促销模版</font>
                        </div>
                        <div class='form-title-bar'>
...
<style>
    .terminalSetting th{background: rgb(237,242,246)}
    .terminalSetting .cell{text-align: center}
    .terminalSetting  .addr-select .el-form-item__content{display:flex;}
    .terminalSetting .el-form-item__label{width:130px;text-align: left;}
</style>

<style scoped>
    .terminalSetting{display: flex;justify-content:center;}
